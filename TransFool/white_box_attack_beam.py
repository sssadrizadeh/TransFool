...
import time
from attacker_beam import Attacker
...
def main(args):
    ...
    with open(f'TransFool/{args.result_folder}/{folder_name_dict[attack_type]}/{args.model_name}_{args.source_lang}_{args.target_lang}_{args.mode}_{args.start_index}_{args.start_index+args.num_samples}_sim_{args.w_sim*10}_perp_{args.w_perp*10}_lr_{args.lr*1000}_ratio_{args.bleu*10}_beam_{args.num_beam}.pkl', 'wb') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--num_beam", default=0, type=int,
        help="number of beams to translate")
